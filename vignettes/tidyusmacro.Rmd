...
`cu.aspect` file: `weight` for the observation month, plus `weight_lag1` and
`weight_lag12`, which are the weights a 1-month and 12-month contribution
calculation actually needs. Coverage is U.S. city average from March 2012
